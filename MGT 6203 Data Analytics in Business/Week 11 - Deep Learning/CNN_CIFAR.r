...
labels <- read.table("C:\\Users\\Clayton\\Documents\\Gatech\\MGT 6203 Data Analytics in Business\\Week 11 - Deep Learning\\fine_label_names.txt")
labels <- labels$V1
labels[1:100]
...
fitted <- luz_load("C:\\Users\\Clayton\\Documents\\Gatech\\MGT 6203 Data Analytics in Business\\Week 11 - Deep Learning\\cnn_cifar.Luz")
...
labels[pred.class[24]]
labels[true.class[24]]
